...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow logo d-flex align-items-center w-auto "
                href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online logo d-flex align-items-center img-responsive img-small-circle">
                    <img src="{{ Auth::user() ? (Auth::user()->profile_photo_url != null ? Auth::user()->profile_photo_url : asset('assets/img/avatars/bini_kamot.jpg')) : asset('assets/img/avatars/bini_kamot.jpg') }}"
                        alt class="rounded-circle img-fluid img-thumbnail">
                </div>
            </a>
