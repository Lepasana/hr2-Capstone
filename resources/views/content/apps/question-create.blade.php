    ...
    <div class="">
        <div class="card">
            <div class="card-datatable table-responsive">
                ...
                @endif
                <div class="p-5">
                    <form action="{{ route('learning-management.question.store', ['examId' => $examId]) }}" method="POST">
                        @csrf
                        @method('POST')
                        ...
                        <div class="mt-5">
                            <button type="button" onclick="location.href = '{{ route('learning-management.show', ['id' => $examId]) }}'"
