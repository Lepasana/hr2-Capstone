...
@section('content')
                ...
                <div class="p-5">
                    <form action="{{ url('/job-qualification/store') }}" method="POST">
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <textarea class="form-control" id="content" cols="20" rows="10" name="content"></textarea>
                        ...
                        <button type="button" id="ai-suggest-btn" class="btn btn-xs btn-outline-primary">AI Suggest</button>
    ...
    <script>
        ...
        document.getElementById('ai-suggest-btn').addEventListener('click', async () => {
            ...
            aiButton.innerText = "Generating qualifications...";
