    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card-body">
            <div class="container" style="margin-top:3%;">
                ...
                <div class="row">
                    <div class="col-md-3 bg-success mr-2"
                        style="height:150px;border-radius:5px;margin-right:1%;margin-bottom:1%;">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="col-md-3 bg-primary mr-2"
                        style="height:150px;border-radius:5px;margin-right:1%;margin-bottom:1%;">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="col-md-3 bg-warning  mr-2"
                        style="height:150px;border-radius:5px;margin-right:1%;margin-bottom:1%;">
                        <div class="row">
                            <div class="col-md-6">
