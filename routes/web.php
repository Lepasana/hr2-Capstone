...
Route::post('/generate-ai-content', [AIController::class, 'generateContent']);

// 2FA Routes
Route::middleware(['auth'])
    ->controller(TwoFactorController::class)
    ->group(function () {
        Route::get('/2fa/setup', 'setup')->name('2fa.setup');
        Route::post('/2fa/enable', 'enable')->name('2fa.enable');
        Route::post('/2fa/disable', 'disable')->name('2fa.disable');
        Route::get('/2fa/show-verify-form', 'showVerifyForm')->name('2fa.show-verify-form');
